...
function defaultMissionError(): string {
  return "Couldn’t create the task. Check Details and try again.";
}
  ...
  const handleSendAudio = useCallback(async () => {
    ...
    try {
      ...
      if (typeof result.text === "string") {
        const message =
          "The request was transcribed, but the task was not created.";
      ...
      const message =
        "Couldn’t create the task. The server returned an unexpected response.";
      appendLog(
  ...
  const handleClarifySubmit = useCallback(
    async (answer: string) => {
      ...
      try {
        ...
        const message =
          "Couldn’t create the task. The clarification response was incomplete.";
        setErrorMessage(message);
        setStatus("error");
        addToast("error", message);
      } catch (err) {
